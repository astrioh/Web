<template>
  ...
  >
      ...
      >
        <div class="text-white body-popover-custom">
          <div class="container-color-popover">
            ...
            >
              На данный момент у Вас нет цветов. Их можно добавить на вкладке "Справочники > Цвета"
            </div>
            <div
    ...
    >
      <template v-if="selectedColor !== '00000000-0000-0000-0000-000000000000' && colors[selectedColor]">
        <svg
          width="24"
          height="24"
          viewBox="0 0 89 90"
