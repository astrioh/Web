...
export default {
  ...
  methods: {
    ...
    emailIntegrate (login, password) {
      this.$store.dispatch(CORP_MEGAFON.YANDEX_CREATE_CORP_EMAIL_INTEGRATION, {
        ya_login: login,
    ...
    removeIntegration () {
      this.$store.dispatch(CORP_MEGAFON.YANDEX_REMOVE_CORP_EMAIL_INTEGRATION, this.user.owner_email)
        .then(() => {
